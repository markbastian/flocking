...
var or__30047__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj44207 = {"detail":data};
return obj44207;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30035__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30035__auto__)){
var and__30035__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__44214 = cljs.core._EQ_;
var expr__44215 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44214.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44215))){
return ((function (pred__44214,expr__44215){
return (function (p1__44208_SHARP_){
return console.warn(p1__44208_SHARP_);
});
;})(pred__44214,expr__44215))
} else {
if(cljs.core.truth_(pred__44214.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44215))){
return ((function (pred__44214,expr__44215){
return (function (p1__44209_SHARP_){
return console.debug(p1__44209_SHARP_);
});
;})(pred__44214,expr__44215))
} else {
if(cljs.core.truth_(pred__44214.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44215))){
return ((function (pred__44214,expr__44215){
return (function (p1__44210_SHARP_){
return console.error(p1__44210_SHARP_);
});
;})(pred__44214,expr__44215))
} else {
return ((function (pred__44214,expr__44215){
return (function (p1__44211_SHARP_){
return console.log(p1__44211_SHARP_);
});
;})(pred__44214,expr__44215))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44218){
var map__44219 = p__44218;
var map__44219__$1 = ((((!((map__44219 == null)))?((((map__44219.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44219.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44219):map__44219);
var opts = map__44219__$1;
var eval_fn = cljs.core.get.call(null,map__44219__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44221_SHARP_);
});})(new_def))
);
...
return (function (p__44222){
var vec__44223 = p__44222;
var ky = cljs.core.nth.call(null,vec__44223,(0),null);
var v = cljs.core.nth.call(null,vec__44223,(1),null);
...
if(cljs.core.truth_((function (){var and__30035__auto__ = typeof localStorage !== 'undefined';
...
}catch (e44228){if((e44228 instanceof Error)){
var e = e44228;
return not_found;
} else {
throw e44228;
...
//# sourceMappingURL=utils.js.map?rel=1505885204666

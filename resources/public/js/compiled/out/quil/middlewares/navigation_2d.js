...
return cljs.core.merge.call(null,initial_state,p1__41041_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_41042 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_41043 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_41042);
var pos_41044 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_41042);
quil.core.scale.call(null,zoom_41043);

var tr__37862__auto___41045 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_41043) - cljs.core.first.call(null,pos_41044)),(((quil.core.height.call(null) / (2)) / zoom_41043) - cljs.core.second.call(null,pos_41044))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__37862__auto___41045);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1505885201412

...
var vec__40990 = axis;
var a_x = cljs.core.nth.call(null,vec__40990,(0),null);
var a_y = cljs.core.nth.call(null,vec__40990,(1),null);
var a_z = cljs.core.nth.call(null,vec__40990,(2),null);
var vec__40993 = v;
var x = cljs.core.nth.call(null,vec__40993,(0),null);
var y = cljs.core.nth.call(null,vec__40993,(1),null);
var z = cljs.core.nth.call(null,vec__40993,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__40996,p__40997){
var vec__40998 = p__40996;
var u1 = cljs.core.nth.call(null,vec__40998,(0),null);
var u2 = cljs.core.nth.call(null,vec__40998,(1),null);
var u3 = cljs.core.nth.call(null,vec__40998,(2),null);
var vec__41001 = p__40997;
var v1 = cljs.core.nth.call(null,vec__41001,(0),null);
var v2 = cljs.core.nth.call(null,vec__41001,(1),null);
var v3 = cljs.core.nth.call(null,vec__41001,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__41004_SHARP_){
return (p1__41004_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__41005_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__41006_SHARP_,angle_lr),angle_ud);
...
var map__41008 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__41008__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__41008__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5457__auto__ = (function (){var pred__41010 = cljs.core._EQ_;
var expr__41011 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__41010.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__41011))){
return straight;
} else {
if(cljs.core.truth_(pred__41010.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__41011))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__41010.call(null,quil.middlewares.navigation_3d.space,expr__41011))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__41010.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__41011))){
return up;
} else {
if(cljs.core.truth_(pred__41010.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__41011))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__41010.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__41011))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5457__auto__,map__41008,map__41008__$1,up,straight){
return (function (p1__41007_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__41007_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5457__auto__,map__41008,map__41008__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__41013_SHARP_);
});})(initial_state))
);
});
/**
...
var map__41014_41025 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__41014_41026__$1 = ((((!((map__41014_41025 == null)))?((((map__41014_41025.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41014_41025.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41014_41025):map__41014_41025);
var vec__41015_41027 = cljs.core.get.call(null,map__41014_41026__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_41028 = cljs.core.nth.call(null,vec__41015_41027,(0),null);
var c_y_41029 = cljs.core.nth.call(null,vec__41015_41027,(1),null);
var c_z_41030 = cljs.core.nth.call(null,vec__41015_41027,(2),null);
var vec__41018_41031 = cljs.core.get.call(null,map__41014_41026__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_41032 = cljs.core.nth.call(null,vec__41018_41031,(0),null);
var u_y_41033 = cljs.core.nth.call(null,vec__41018_41031,(1),null);
var u_z_41034 = cljs.core.nth.call(null,vec__41018_41031,(2),null);
var vec__41021_41035 = cljs.core.get.call(null,map__41014_41026__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_41036 = cljs.core.nth.call(null,vec__41021_41035,(0),null);
var p_y_41037 = cljs.core.nth.call(null,vec__41021_41035,(1),null);
var p_z_41038 = cljs.core.nth.call(null,vec__41021_41035,(2),null);
quil.core.camera.call(null,p_x_41036,p_y_41037,p_z_41038,(p_x_41036 + c_x_41028),(p_y_41037 + c_y_41029),(p_z_41038 + c_z_41030),u_x_41032,u_y_41033,u_z_41034);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1505885201383

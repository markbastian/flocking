...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30718__auto__,writer__30719__auto__,opt__30720__auto__){
return cljs.core._write.call(null,writer__30719__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__5461__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
if((temp__5461__auto__ == null)){
return (reagent.impl.template.prop_name_cache[cljs.core.name.call(null,k)] = reagent.impl.util.dash_to_camel.call(null,k));
} else {
var k_SINGLEQUOTE_ = temp__5461__auto__;
...
var G__40848 = o;
(G__40848[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__40849__delegate = function (args){
...
return G__40849__delegate.call(this,args);};
...
return G__40849__delegate(args);
});
...
var temp__5461__auto__ = (id_class["className"]);
if((temp__5461__auto__ == null)){
return p__$1;
} else {
var class$ = temp__5461__auto__;
...
if(cljs.core.truth_((function (){var and__30035__auto__ = !((jsprops == null));
if(and__30035__auto__){
var and__30035__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__40854 = jsprops;
(G__40854["defaultValue"] = value);

(G__40854["onChange"] = ((function (G__40854,v,value,on_change){
return (function (p1__40853_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__40853_SHARP_);
});})(G__40854,v,value,on_change))
);
...
var vec__40857 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__40857,(0),null);
var id = cljs.core.nth.call(null,vec__40857,(1),null);
var class$ = cljs.core.nth.call(null,vec__40857,(2),null);
...
var temp__5461__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__5461__auto__ == null)){
return reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null));
} else {
var k = temp__5461__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__5463__auto___40861 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5463__auto___40861 == null)){
} else {
var key_40862 = temp__5463__auto___40861;
(jsprops["key"] = key_40862);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__40863 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__40863["name"] = c);
...
var temp__5461__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__5461__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag.call(null,x));
} else {
var s = temp__5461__auto__;
return s;
}
});
...
var len__31324__auto___40868 = arguments.length;
var i__31325__auto___40869 = (0);
while(true){
if((i__31325__auto___40869 < len__31324__auto___40868)){
args__31331__auto__.push((arguments[i__31325__auto___40869]));

var G__40870 = (i__31325__auto___40869 + (1));
i__31325__auto___40869 = G__40870;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31332__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq40866){
var G__40867 = cljs.core.first.call(null,seq40866);
var seq40866__$1 = cljs.core.next.call(null,seq40866);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__40867,seq40866__$1);
});
...
break;
default:
var G__40873 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__40873;
continue;
...
var n__31090__auto___40875 = a.length;
var i_40876 = (0);
while(true){
if((i_40876 < n__31090__auto___40875)){
(a[i_40876] = reagent.impl.template.as_element.call(null,(a[i_40876])));
...
var a = cljs.core.into_array.call(null,s);
var n__31090__auto___40878 = a.length;
var i_40879 = (0);
while(true){
if((i_40879 < n__31090__auto___40878)){
var val_40880 = (a[i_40879]);
if((cljs.core.vector_QMARK_.call(null,val_40880)) && ((reagent.impl.template.key_from_vec.call(null,val_40880) == null))){
(o["no-key"] = true);
} else {
}

(a[i_40879] = reagent.impl.template.as_element.call(null,val_40880));

var G__40881 = (i_40879 + (1));
i_40879 = G__40881;
continue;
} else {
}
...
var ctx = ({});
var vec__40882 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__40882,(0),null);
var derefed = cljs.core.nth.call(null,vec__40882,(1),null);
...
var G__40885 = (cljs.core.count.call(null,argv) - first_child);
switch (G__40885) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__40885){
...
//# sourceMappingURL=template.js.map?rel=1505885201170
